                            ...
                            <div class="card sale-card" style="min-height:550px!important;">
                                ...
                                <div class="page-body">
                                    <div class="card-block">
                                        <form method="POST" id="submit-form" action="{{ route('blog.update', $blog->id)}}" enctype="multipart/form-data">
                                            @csrf
                                            @method('PUT')
                                                ...
                                                <div class="col-lg-9">
                                                    <select name="blog_category_id" id="" class="form-control select-search @error('blog_category_id') is-invalid @enderror">
                                                        ...
                                                        @foreach($categories as $category)
                                                            <option value="{{ $category->id }}" {{ (old('blog_category_id', $blog->blog_category_id) ==  $category->id) ? 'selected=selected':'' }}>{{ $category->title }}</option>
                                                        @endforeach
                                                    </select>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-9">
                                                    <select name="status" class="form-control select-search @error('status') is-invalid @enderror">
                                                        <option value="active" {{ (old('status', $blog->status) == 'active' ) ? 'selected=selected':''}}>Enabled</option>
                                                        <option value="inactive" {{ (old('status', $blog->status) == 'inactive' ) ? 'selected=selected':''}}>Disabled</option>
                                                    </select>
                                                    @error('status')
                                                    <div class="text-danger">{{ $message }}</div>
                                                    @enderror
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-9">
                                                    <input type="text" name="title" class="form-control @error('title') is-invalid @enderror" onkeyup="titleSlug(this.value)" placeholder="Title" value="{{ old('title', $blog->title) }}">
                                                    @error('title')
                                                    <div class="text-danger">{{ $message }}</div>
                                                    @enderror
                                                </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-9">
                                                    <input type="text" id="slug" name="slug" class="form-control @error('slug') is-invalid @enderror" placeholder="Slug" value="{{ old('slug', $blog->slug) }}">
                                                    @error('slug')
                                                    <div class="text-danger">{{ $message }}</div>
                                                    @enderror
                                                </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-9">
                                                    <input type="text" name="name" class="form-control @error('name') is-invalid @enderror" placeholder="Blogger's Name" value="{{ old('name', $blog->name) }}">
                                                    @error('name')
                                                    <div class="text-danger">{{ $message }}</div>
                                                    @enderror
                                                </div>
                                            ...
                                            @if(!is_null($blog->image))
                                                <div class="row mb-3">
                                                    <div class="col-8 offset-3">
                                                        <img src="{{ asset('public/storage/uploads/blogs/'. $blog->image) }}" class="img-fluid" style="width:20%;">
                                                    </div>
                                                </div>
                                            @endif
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-9">
                                                    <textarea id="summernote" name="description" class="form-control" cols="30" rows="10" placeholder="Description">{{ old('description', $blog->description) }}</textarea>
                                                </div>
                                            </div>
                                            <hr>
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-9">
                                                    <input type="text" name="meta_title" class="form-control @error('meta_title') is-invalid @enderror" placeholder="Meta title" value="{{ old('meta_title', $blog->meta_title) }}">
                                                    @error('meta_title')
                                                    <div class="text-danger">{{ $message }}</div>
                                                    @enderror
                                                </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-9">
                                                    <textarea name="meta_keyword" id="" cols="30" rows="5" class="form-control @error('meta_keyword') is-invalid @enderror" placeholder="Meta keywords">{{ old('meta_keyword', $blog->meta_keyword) }}</textarea>
                                                    @error('meta_keyword')
                                                    <div class="text-danger">{{ $message }}</div>
                                                    @enderror
                                                </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-9">
                                                    <textarea name="meta_description" id="" cols="30" rows="10" class="form-control @error('meta_description') is-invalid @enderror" placeholder="Meta Description">{{ old('meta_description', $blog->meta_description) }}</textarea>
